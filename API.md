...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#lb-sls.LBSls.toString">toString</a></code> | Returns a string representation of this construct. |
...
| <code><a href="#lb-sls.LBSls.addPackageIgnore">addPackageIgnore</a></code> | Adds patterns to be ignored by npm. |
...
| <code><a href="#lb-sls.LBSls.addScripts">addScripts</a></code> | Replaces the contents of multiple npm package.json scripts. |
...
##### `toString` <a name="toString" id="lb-sls.LBSls.toString"></a>
...
##### `addScripts` <a name="addScripts" id="lb-sls.LBSls.addScripts"></a>
...
###### `scripts`<sup>Required</sup> <a name="scripts" id="lb-sls.LBSls.addScripts.parameter.scripts"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#lb-sls.LBSls.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#lb-sls.LBSls.isProject">isProject</a></code> | Test whether the given construct is a project. |
| <code><a href="#lb-sls.LBSls.of">of</a></code> | Find the closest ancestor project for given construct. |

---

##### `isConstruct` <a name="isConstruct" id="lb-sls.LBSls.isConstruct"></a>

```typescript
import { LBSls } from 'lb-sls'

LBSls.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="lb-sls.LBSls.isConstruct.parameter.x"></a>
...
##### `isProject` <a name="isProject" id="lb-sls.LBSls.isProject"></a>

```typescript
import { LBSls } from 'lb-sls'

LBSls.isProject(x: any)
```

Test whether the given construct is a project.

###### `x`<sup>Required</sup> <a name="x" id="lb-sls.LBSls.isProject.parameter.x"></a>

- *Type:* any

---

##### `of` <a name="of" id="lb-sls.LBSls.of"></a>

```typescript
import { LBSls } from 'lb-sls'

LBSls.of(construct: IConstruct)
```
...
###### `construct`<sup>Required</sup> <a name="construct" id="lb-sls.LBSls.of.parameter.construct"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#lb-sls.LBSls.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
...
| <code><a href="#lb-sls.LBSls.property.subprojects">subprojects</a></code> | <code>projen.Project[]</code> | Returns all the subprojects within this project. |
...
| <code><a href="#lb-sls.LBSls.property.npmrc">npmrc</a></code> | <code>projen.javascript.NpmConfig</code> | The .npmrc file. |
...
| <code><a href="#lb-sls.LBSls.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | Maximum node version required by this package. |
...
##### `node`<sup>Required</sup> <a name="node" id="lb-sls.LBSls.property.node"></a>
...
##### `subprojects`<sup>Required</sup> <a name="subprojects" id="lb-sls.LBSls.property.subprojects"></a>
...
##### `npmrc`<sup>Required</sup> <a name="npmrc" id="lb-sls.LBSls.property.npmrc"></a>
...
| <code><a href="#lb-sls.LBSls.property.DEFAULT_TS_JEST_TRANFORM_PATTERN">DEFAULT_TS_JEST_TRANFORM_PATTERN</a></code> | <code>string</code> | *No description.* |
...
##### `DEFAULT_TS_JEST_TRANFORM_PATTERN`<sup>Required</sup> <a name="DEFAULT_TS_JEST_TRANFORM_PATTERN" id="lb-sls.LBSls.property.DEFAULT_TS_JEST_TRANFORM_PATTERN"></a>
